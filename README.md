...
System Requirements
Instructions
Processor (CPU): Dual-core (Intel i3 or equivalent) — Recommended: Intel i5 / Ryzen 5 or higher

RAM: Minimum 8 GB — Recommended: 16 GB for handling large datasets

Storage: Minimum 2–3 GB free — Recommended: SSD with 10+ GB free space

Operating System: Windows 10/11 (64-bit) or macOS (latest supported versions)

Software: Tableau Desktop or Tableau Public

Browser: Latest version of Chrome, Edge, or Safari

Data Sources: Excel, CSV, or databases (e.g., SQL)
